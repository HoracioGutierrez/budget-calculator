                ...
                <Tabs defaultValue="frontend" className="w-full">
                  ...
                  <TabsContent value="frontend" className="mt-6">
                    <div className="grid md:grid-cols-2 gap-4">
                      {getCategoryServices("frontend").map(renderServiceCard)}
                    </div>
                  </TabsContent>

                  <TabsContent value="backend" className="mt-6">
                    <div className="grid md:grid-cols-2 gap-4">
                      {getCategoryServices("backend").map(renderServiceCard)}
                    </div>
                  </TabsContent>

                  <TabsContent value="integrations" className="mt-6">
                    <div className="grid md:grid-cols-2 gap-4">
                      {getCategoryServices("integrations").map(renderServiceCard)}
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="custom" className="mt-6">
                    <div className="space-y-4">
                      <div>
                        <Label htmlFor="custom-feature">{t.customFeatures}</Label>
                        <Textarea
                          id="custom-feature"
                          placeholder={t.customFeaturePlaceholder}
                          value={customInput}
                    ...
                    {customFeatures.length > 0 && (
                      <div className="mt-6 space-y-3">
                        <h4 className="font-medium">{t.customFeatures}:</h4>
